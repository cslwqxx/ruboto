...
ANDROID_TARGETS="22 21 19 17 16 15" # We should cover at least 90% of the market
ANDROID_TARGETS="22" # We should cover at least 90% of the market
PLATFORM_MODES="CURRENT FROM_GEM STANDALONE"
PLATFORM_MODES="CURRENT"
